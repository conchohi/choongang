...
public class Exam08 {
	...
	static String[] beverage = {"아메리카노","라떼","콜라","홍차"};
	static int[] price = {2500,4500,1500,5500};
	static int[] numberOfOrders = new int[4];
	static int[] amountOfMoney = new int[4];
	...
	public static void printOrder() {
		...
		int totalPaymentAmount = getSum(amountOfMoney);
		int totalOrderAmount = getSum(numberOfOrders);
		System.out.println("===============================");
